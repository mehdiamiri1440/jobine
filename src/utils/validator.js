...
export const isNumberMoreThanZero = text => {
    return /^[1-9][0-9]*$/.test(text);
};
...
export const isPersianOrEnglishNumber = txt => {
    if (txt === null || txt === undefined || txt === '') {
        return false;
    }

    return /^[0-9۰-۹]*$/.test(txt);
};
